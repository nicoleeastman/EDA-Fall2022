...
df_withdrawals <- data.frame("Water_System" = water.system.name,
                               ...
                               "Ownership" = ownership,
                                ...
                                "Month" = rep(1:12),
                                "Year" = rep(2021))
df_withdrawals$Month[c(1:12)] <- c("Jan", "May", "Sept", "Feb", "Jun", "Oct", "Mar", "Jul", "Nov", "Apr", "Aug", "Dec")
...
df_PSWID <- data.frame("Water_System" = water.system.name,
                               "PSWID" = pswid,
                               "Ownership" = ownership,
                                "Max_Withdrawals" = max.withdrawals.mgd,
                                "Month" = rep(1:12),
                                "Year" = rep(2015))
df_PSWID$Month[c(1:12)] <- c("Jan", "May", "Sept", "Feb", "Jun", "Oct", "Mar", "Jul", "Nov", "Apr", "Aug", "Dec")

...
#9
EPA.final <- separate(EPA.filtered, AQS_PARAMETER_DESC, c("PM2.5", "Ozone"))

#10
dim(EPA.final)

#11
write.csv(EPA.final, file ="Data/Processed/EPAair_O3_PM25_NC1718_Processed.csv", row.names= FALSE)

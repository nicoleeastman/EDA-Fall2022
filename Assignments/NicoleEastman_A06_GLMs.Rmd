...
```{r tukey.test}
#15
Chem.HSD <- HSD.test(Chem.aov, "lakename", group = TRUE)
Chem.HSD
...
>Answer: Ward Lake and Paul Lake's mean temperatures are statistically the same as Peter Lake's mean temperature. No Lake isstatistically distinct from the others.

 

17. If we were just looking at Peter Lake and Paul Lake. What's another test we might explore to see whether they have distinct mean temperatures? 

>Answer: The two-sample T-test will identify whether Peter Lake and Paul Lake have distinct mean temperatures. 
...
Chem.TTest<- t.test(Chem.Subset$temperature_C ~ Chem.Subset$lakename, var.equal= TRUE)
summary(Chem.TTest)
Chem.Two.Sample <- lm(Chem.Subset$temperature_C ~ Chem.Subset$lakename)
summary(Chem.Two.Sample)

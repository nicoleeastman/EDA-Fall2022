...
#adding two columns to components
...
Let's refer to our wind speed data. We already performed interpolation, but we still need to create our time series object and decompose the series to find out which stationary test we can apply. 
...
#reject hypothesis and say we have trend

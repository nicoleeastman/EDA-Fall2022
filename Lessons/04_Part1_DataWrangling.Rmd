...
`!=`
# check if vairable are different
`<`
# less than number 
`<=`
...
# matrix filtering, finding values on surface of lake
...
# choose either or for paul and peter lakes
...
# look through dataset to find first date of june's dayum and last day of october

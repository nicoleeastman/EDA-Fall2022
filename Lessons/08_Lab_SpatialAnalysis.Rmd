...
mapview(huc8_sf, col.regions = 'orange') +
  mapview(huc8_sf_filtered, col.regions = 'purple', alpha.regions = 1)
...
#View the outputs
mapview(wind_HUC8_join, zcol = "kWhkm2day")
...
huc8_sf_utm <-     st_transform(huc8_sf)
huc2_utm <-     st_transform(huc2_sf)   
```
...
#filter(st_interesects(x= ., y =triangle_co, sparse = F))
